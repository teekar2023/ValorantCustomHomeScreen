...
os.system(f'xcopy "{cwd}\\Videos\\{vid}.mp4" "C:\\Riot Games\\VALORANT\\live\\ShooterGame\\Content\\Movies\\Menu" /K /H /Y')
...
os.rename(f'C:\\Riot Games\\VALORANT\\live\\ShooterGame\\Content\\Movies\\Menu\\{vid}.mp4', 'C:\\Riot Games\\VALORANT\\live\\ShooterGame\\Content\\Movies\\Menu\\HomeScreen.mp4')
print("Video Renamed")
